-- Wallpaper-derived theme — generated by Matugen.
return {
    active_border = {
    ...
    active_border_hyprctl = "rgb({{colors.primary.default.hex_stripped}}) rgb({{colors.secondary.default.hex_stripped}}) rgb({{colors.tertiary.default.hex_stripped}})",
